...
namespace alx {
    ...
    template<typename T> struct is_arithmetic { static constexpr bool value{is_integral_v<T>}; };
    ...
    template<typename T, bool = is_arithmetic_v<T>> struct is_signed {
    ...
    template<typename T> struct is_signed<T, false> { static constexpr bool value{false}; };
